    ...
    Slider.prototype = {
        ...
        setLayout: function(){
            ...
            if(this.options.isShowControls){
                this.$prev = $('<a href="javascript:;" class="hiSlider-btn-prev"><i class="fa fa-chevron-circle-left"></i></a>');
                this.$next = $('<a href="javascript:;" class="hiSlider-btn-next"><i class = "fa fa-chevron-circle-right"></i></a>');
