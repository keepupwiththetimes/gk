...
class ProductController extends CommonController
{
    ...
    public function lists()
    {
        ...
        //$product_list = $ProductModel->getProductList($type, $three_cityid, 0, 6);
        $product_list = $ProductModel->getProductList($type, 0, 6);
    ...
    public function view()
    {
        ...
        // 获取商品信息
        $product_info = getProductInfo($id);
