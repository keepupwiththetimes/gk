...
class AjaxController extends Controller
{
    ...
    {
    	doLog('Index/ListAllProducts', '点击查看平台所有商品', '', '', $this->redisLog);
    }
    
    // 记录登录框弹出事件
    public function popupLoginWindow()
    {
    	doLog('Member/login/popupLoginWindow', '显示登录框', '', $_SESSION[$_SESSION['PLATFORM_CODE']]['tel'], $this->redisLog);
    }
    
    // 关闭登录框弹出事件
    public function closeLoginWindow()
    {
    	doLog('Member/login/closeLoginWindow', '点x关闭登录框', '', $_SESSION[$_SESSION['PLATFORM_CODE']]['tel'], $this->redisLog);
    }
